...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) BOOL isPrint;)
+ (BOOL)isPrint SWIFT_WARN_UNUSED_RESULT;
+ (void)setIsPrint:(BOOL)value;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, copy) NSString * _Nonnull resulticksSdkVersion;)
+ (NSString * _Nonnull)resulticksSdkVersion SWIFT_WARN_UNUSED_RESULT;
+ (void)setResulticksSdkVersion:(NSString * _Nonnull)value;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, copy) NSString * _Nonnull idenfier;)
+ (NSString * _Nonnull)idenfier SWIFT_WARN_UNUSED_RESULT;
+ (void)setIdenfier:(NSString * _Nonnull)value;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC8REIOSSDK11RSTextField")
...
SWIFT_CLASS("_TtC8REIOSSDK13RSUIImageView")
@interface RSUIImageView : UIImageView
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (void)didMoveToWindow;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder SWIFT_UNAVAILABLE;
...
SWIFT_CLASS("_TtC8REIOSSDK9RSUILabel")
@interface RSUILabel : UILabel
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (void)didMoveToWindow;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder SWIFT_UNAVAILABLE;
@end
